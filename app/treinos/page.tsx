  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {treinos.map((treino) => (
          <div key={treino.id} className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <Link href={`/treinos/${treino.id}`}>
              <div className="relative h-48 w-full">
                <Image
                  src={treino.exercicios[0].img} // imagem do primeiro exercício
                  alt={treino.nome}
                  fill
            ...
            <div className="p-4">
              <span className="text-sm text-gray-600 mb-2 block">{treino.grupo}</span>
